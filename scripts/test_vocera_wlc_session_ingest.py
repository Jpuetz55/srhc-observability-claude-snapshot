...
def test_study_web_ingest_contract() -> None:
    ...
    require("wlc_cli.transcript_command_blocks(" in main_text, "transcript ingest must split terminal logs into command blocks")
    require("transcript_block_parser_version" in main_text, "terminal artifact metadata must identify the block parser version")
