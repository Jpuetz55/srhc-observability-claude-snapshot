...
def test_media_study_sql_contract() -> None:
    ...
    require("Vocera Multicast Capture Sessions" in media_wlc_sessions_text, "WLC session UI should be labeled as multicast investigation")
    require("Configured Vocera multicast VLAN" in media_wlc_sessions_text, "WLC session UI should expose configured multicast VLAN")
    require("Badge client VLAN observations do not automatically change this value" in media_wlc_sessions_text, "WLC session UI should explain VLAN authority")
    require("Find Active Group Candidates" in media_wlc_sessions_text and "Override active-group VLAN reason" in media_wlc_sessions_text, "WLC session UI should require explicit active-group selection")
